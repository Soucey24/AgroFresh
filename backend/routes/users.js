...
import { listUsers, createUser, updateUser, deleteUser, getUser, uploadAvatar, changePassword, verifyEmailChange, updateProfile, getProfile, verifyPhotos } from '../controllers/userController.js';
...
router.post('/verify-photos', verifyPhotos); // POST /api/users/verify-photos
