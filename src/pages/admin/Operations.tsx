    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Operations Team</h1>
            <p className="text-sm text-muted-foreground">Collection point, quality checks, packing, and dispatch overview for {todayLabel()}</p>
          </div>
        </div>
